...
$(document).ready(function () {
    ...
    EMPTY_SQUARE.leftx = "300px";   //left position initial
    EMPTY_SQUARE.toppx = "300px";   //top position initial


//function to set position of the puzles with css 
    ...
    var images= ["url('./images/background.jpg')", "url('./images/487678.jpg')", "url('./images/wp2509853.jpg')"];
    var index=0;
...
//        console.log(arr); //for debugging purpose
    ...
    //function that swaps the value by checking if the square can be moved  
...
$('.puzzlepiece').click(function ()
{
    ...
    //on hover function that changes and removes the css
